...
CREATE TABLE `ingredientbatch` (
  ...
  CONSTRAINT `ingredientbatch_ibfk_1` FOREIGN KEY (`ingredientID`) REFERENCES `ingredient` (`ingredientID`),
  CONSTRAINT `ingredientbatch_ibfk_2` FOREIGN KEY (`supplierID`) REFERENCES `supplier` (`supplierID`),
  CONSTRAINT `ingredientbatch_ibfk_3` FOREIGN KEY (`batchNumber`) REFERENCES `batch` (`batchNumber`)
...
-- Dump completed on 2024-11-13 15:02:04
